...
MAX_RESULTS_PER_REQUEST = 15  # Увеличено с 5 до 15

def get_youtube_client():
    api_key = os.getenv('YOUTUBE_API_KEY')
    return build('youtube', 'v3', developerKey=api_key)

def search_popular_shorts(region_code="US", category_id=None, max_results=MAX_RESULTS_PER_REQUEST):
    """
...
def search_by_keyword(keyword, region_code="US", max_results=MAX_RESULTS_PER_REQUEST):
    """
